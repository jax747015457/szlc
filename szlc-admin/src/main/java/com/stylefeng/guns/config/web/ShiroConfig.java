...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(DefaultWebSecurityManager securityManager) {
        ...
        hashMap.put("/kaptcha/**", "anon");
        // 小强支付请求跳过验证
        hashMap.put("/api/xqPay/**", "anon");
        // 回款订单扫码信息跳过验证
        hashMap.put("/orderRebate/scan", "anon");
        hashMap.put("/orderRebate/getQRcode", "anon");
        hashMap.put("/orderRebate/unlockSpId", "anon");
        hashMap.put("/orderRebate/qrcode", "anon");
        hashMap.put("/**", "user");
